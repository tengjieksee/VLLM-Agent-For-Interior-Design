...
declare const toolHooksSchema: z.ZodObject<{
  ...
  afterToolCall: z.ZodOptional<z.ZodFunction<z.ZodTuple<[z.ZodObject<{
    ...
    }>, z.ZodType<ContentBlock.Multimodal.Standard, z.ZodTypeDef, ContentBlock.Multimodal.Standard>]>, "many">], null>, z.ZodType<ToolMessage<_langchain_core_messages0.MessageStructure>, z.ZodTypeDef, ToolMessage<_langchain_core_messages0.MessageStructure>>]>;
  }, "result">, "strip", z.ZodTypeAny, {
    result: string | Command<unknown, Record<string, unknown>, string> | ToolMessage<_langchain_core_messages0.MessageStructure> | [string | (ContentBlock | ContentBlock.Data.DataContentBlock)[], ({
      type: "resource";
      resource: {
        uri: string;
        mimeType?: string | undefined;
